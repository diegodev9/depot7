...
exports.StimulusHTMLDataProvider = void 0;
const events_1 = require("../events");
const utils_1 = require("../utils");
class StimulusHTMLDataProvider {
    ...
    provideAttributes(_tag) {
        ...
        const valueAttribtues = this.controllers
            ...
            return Object.keys(controller.values).map((value) => {
                return { name: `data-${controller.identifier}-${(0, utils_1.dasherize)(value)}-value` };
            });
        });
        const classAttribtues = this.controllers
            .flatMap((controller) => {
            return controller.classes.map((klass) => {
                return { name: `data-${controller.identifier}-${(0, utils_1.dasherize)(klass)}-class` };
            });
        });
        return [
    ...
    provideValues(_tag, attribute) {
        ...
        if (attribute == "data-action") {
            ...
            //   ..."0123456789".split(""),
            // ]
            const controllersWithEvents = events_1.EVENTS.flatMap((event) => {
...
exports.StimulusHTMLDataProvider = StimulusHTMLDataProvider;
//# sourceMappingURL=stimulus_html_data_provider.js.map